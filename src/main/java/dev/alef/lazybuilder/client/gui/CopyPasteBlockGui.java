...
//CLIENT
public class CopyPasteBlockGui extends ContainerScreen<CopyPasteBlockContainer> implements IHasContainer<CopyPasteBlockContainer> {

	@SuppressWarnings("unused")
    private final static Logger LOGGER = LogManager.getLogger();
	
	private static final ResourceLocation field_147017_u = new ResourceLocation(Refs.MODID, "textures/gui/container/start_block_gui.png");
	private final int field_147018_x;
	private final int field_147000_g;

	public CopyPasteBlockGui(CopyPasteBlockContainer p_i51095_1_, PlayerInventory p_i51095_2_, ITextComponent p_i51095_3_) {
