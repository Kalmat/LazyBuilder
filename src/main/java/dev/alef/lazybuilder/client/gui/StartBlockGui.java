...
@OnlyIn(Dist.CLIENT)
public class StartBlockGui extends ContainerScreen<StartBlockContainer> implements IHasContainer<StartBlockContainer> {
	...
	public StartBlockGui(StartBlockContainer p_i51095_1_, PlayerInventory p_i51095_2_, ITextComponent p_i51095_3_) {
