...
public final class TileEntityList {
	...
	public static final RegistryObject<TileEntityType<ProtectBlockTileEntity>> PROTECT_BLOCK = TILEENTITY_LIST.register("protect_block", () ->
								TileEntityType.Builder.create(ProtectBlockTileEntity::new, BlockList.protect_block).build(null));
}
